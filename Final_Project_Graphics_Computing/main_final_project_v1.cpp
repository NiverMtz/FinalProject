...
/* ----------------   Práctica 10 --------------------------*/
/*-----------------    2021-1   ---------------------------*/
/*------------- Alumno: Martínez Hernández Niver Asaid ---------------*/
#include <Windows.h>
...
void interpolation(void)
{
	...
	cabezaInc = (KeyFrame[playIndex + 1].movcabeza - KeyFrame[playIndex].movcabeza) / i_max_steps;
}
...
int main()
{
	...
	Model personaje("resources/objects/Personaje2/PersonajePrueba.obj");
...
void my_input(GLFWwindow *window, int key, int scancode, int action, int mode)
{
	...
	if (glfwGetKey(window, GLFW_KEY_C) == GLFW_PRESS)
		rotRodIzq++;
	if (glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS) // Agrego
		rotRodDer--;
	if (glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS) //Agrego
		rotRodDer++;
	...
	if (glfwGetKey(window, GLFW_KEY_M) == GLFW_PRESS)
		movBrazoDer += 2.0f;
	if (glfwGetKey(window, GLFW_KEY_END) == GLFW_PRESS) // Agrego
		movBrazoIzq -= 2.0f;
	if (glfwGetKey(window, GLFW_KEY_HOME) == GLFW_PRESS) // Agrego
		movBrazoIzq += 2.0f;
	if (glfwGetKey(window, GLFW_KEY_LEFT) == GLFW_PRESS) // Agrego
		movcabeza -= 2.0f;
	if (glfwGetKey(window, GLFW_KEY_RIGHT) == GLFW_PRESS) // Agrego
		movcabeza += 2.0f;
